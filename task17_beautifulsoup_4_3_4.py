...
def main():
    ...
    total_sum = sum([int(img.attrs['alt']) for img in img_tags])
    # sum([int(img.get('alt')) for img in img_tags])
    # sum(int(img['alt']) for img in img_tags if img.get('alt') and img['alt'].isdigit())
